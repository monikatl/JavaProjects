...
public class FunctionsPractise implements Practise, PractiseBuilder {
    ...
    public void compareSubdominant(){
       compareSubdominant = compareKeys(userHarmonicTriad[0], randomHarmonicTriadNames[1]);
        if (!compareSubdominant){
            ...
            System.out.println("Poprawna subdominanata w tonacji --" + randomHarmonicTriadNames[0] + "-- to  --" + randomHarmonicTriadNames[1] + "-- ");
        }
    }
    ...
    public void compareDominant(){
        ...
        if (!compareDominant) {
            ...
            System.out.println("Poprawna dominanata w tonacji --" + randomHarmonicTriadNames[0] + "-- to  --" + randomHarmonicTriadNames[2] + "--");
        }
    }
